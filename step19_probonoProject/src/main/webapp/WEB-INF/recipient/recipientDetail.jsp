...
<br><br><br>
<a href="${pageContext.request.contextPath}/probono/recipientUpdateReq?recipientId=${requestScope.recipient.id}">수정하기</a>

<a href="${pageContext.request.contextPath}/probono/recipientDelete?recipientId=${requestScope.recipient.id}">탈퇴하기</a>
